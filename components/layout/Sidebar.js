				...
				<div className="sidebar-textwidget">
					...
					<div className="sidebar-info-contents">
						<div className="content-inner">
							<div className="logo">
								<Link href="/"><img style={{width:'100px'}} src="assets/slider/newlogo.png" alt="" /></Link>
							</div>
							<div className="content-box">
								...
								<Link href="contact" className="theme-btn btn-style-one clearfix"><span className="icon"></span>Contactus</Link>
							</div>
							<div className="contact-info">
								...
								<ul className="list-style-one">
									...
									<li><span className="icon fa fa-envelope"></span>presman@gmail.com</li>
