                ...
                <div className="header-upper">
                    <div className="auto-container clearfix">
                        ...
                        <div className="pull-left logo-box">
                            <div className="logo" style={{width:'5rem'}}><Link href="/"><img src="assets/slider/newlogo.png" alt="" title=""/></Link></div>
                        </div>
                ...
                <div className="sticky-header">
                    <div className="auto-container clearfix">
                        <div className="logo pull-left">
                            <Link href="/" title=""><img style={{width:'80px'}} src="assets/slider/newlogo.png" alt="" title="" /></Link>
                        </div>
