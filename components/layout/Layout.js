...
export default function Layout({ headerStyle, footerStyle, headTitle, breadcrumbTitle, children, wrapperCls,heading }) {
    ...
    return (
        <>
            ...
            <div className={`page-wrapper ${wrapperCls ? wrapperCls : ""}`} id="#top">
                ...
                {breadcrumbTitle && <Breadcrumb breadcrumbTitle={breadcrumbTitle} heading={heading} />}
