...
const slideThemes = {
    ...
    6: 'dark'   // Fifth slide (index 4) - dark background theme
}
    ...
    return (
     ...
     >
               ...
               <div className="slide style-five">
                <div className="icon-layer-one " style={{ backgroundImage: 'url(assets/images/removed_banner_bg/sugarfinal.png)',backgroundRepeat: "no-repeat",
                backgroundPosition: "center",
                backgroundSize: "contain", }}></div>
